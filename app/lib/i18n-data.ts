  ...
  de: {
    ...
    plan: {
      ...
      budget: {
        ...
        customHint: "Gib einen Betrag in CHF für den Gesamtpreis an.",
      },
      travelers: {
  ...
  fr: {
    ...
    plan: {
      ...
      budget: {
        ...
        customHint: "Saisissez un budget total en CHF.",
      },
      travelers: {
  ...
  it: {
    ...
    plan: {
      ...
      budget: {
        ...
        customHint: "Inserisci un budget totale in CHF.",
      },
      travelers: {
  ...
  rm: {
    ...
    plan: {
      ...
      budget: {
        ...
        customPlaceholder: "p.ex. 2500",
        customHint: "Endatescha il budget total en CHF.",
      },
      travelers: {
  ...
  en: {
    ...
    plan: {
      ...
      budget: {
        ...
        customHint: "Enter a total budget amount in CHF.",
      },
      travelers: {
